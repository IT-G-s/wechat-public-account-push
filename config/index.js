export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxc580714f66a092dd",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "022c596f54a6ac3370cecbe2527a4bc9",
  ...
  USERS: [
    {
      ...
      id: "oCdRj6KBUFsKEOlR2fITuNdbNAVE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	1mKCxTh1gR-ZCUfblZUZvKyvYTE8Qegda9_90ujqyhs",
      // 所在省份
      province: "内蒙古",
      // 所在城市
      city: "呼和浩特",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "张超", "year": "1999", "date": "08-12"},
        //{"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "张超", "year": "1999", "date": "07-02"},
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oCdRj6PQw-rFbGm3RcwnA_ouf5hI",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
